...
if eeObj.ReadMem32(0x0012513C) == 0x24040002 then

eeObj.WriteMem32(0x0012513C,0x24040001) --24040002
eeObj.WriteMem32(0x001C5BC0,0x24040001) --24040002
eeObj.WriteMem32(0x00102638,0x24040032) --24040019
eeObj.WriteMem32(0x00125128,0x2410003C) --2410001E

end

if eeObj.ReadMem32(0x0012513C) == 0x24040001 then
